...
pages_url    := https://deanwampler.github.io/
site_dir     := .
clean_dirs   := ${site_dir}/_site ${site_dir}/.sass-cache
...
ifndef site_dir
$(error ERROR: There is no ${site_dir} directory!)
endif
...
ERROR: Check that the /usr/local/lib/ruby/gems/3.X.Y/gems/bundler-X.Y.Z directory actually exists. 
